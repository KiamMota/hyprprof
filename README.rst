...
For detailed CLI commands and usage, refer to the CLI documentation in ``doc/cli``_.

For detailed information about creating and structuring profiles, see the profile documentation in ``doc/profile``_.

.. _doc/cli: doc/cli
.. _doc/profile: doc/profile
